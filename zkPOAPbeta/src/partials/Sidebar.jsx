    ...
    <div className="min-w-fit">
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <svg className="fill-violet-500" xmlns="http://www.w3.org/2000/svg" width={42} height={42} viewBox="0 0 32 32">
            <path
            ...
            />
            <path
              d="M16,24c0.3,0,0.5-0.1,0.7-0.2c0.2-0.2,0.3-0.4,0.3-0.7l0.2-1.2c-0.8,0.2-1.6,0.2-2.4,0l0.2,1.2  c0,0.3,0.1,0.5,0.3,0.7C15.5,23.9,15.7,24,16,24z M22.9,23.8h1.9V12.9c0-1.5-0.7-2.5-1.9-2.9V23.8z M7.2,23.8h1.9V10  c-1.2,0.4-1.9,1.4-1.9,2.9V23.8z M17.2,21.9c1.2-0.3,2.1-1.2,2.3-2.8l1.2-9.2c-1.4,0.3-2.1,1.4-2.4,3.1L17.2,21.9z M14.8,21.9  L13.7,13c-0.2-1.7-1-2.8-2.3-3.1l1.2,9.2C12.8,20.7,13.6,21.6,14.8,21.9L14.8,21.9z M22.9,10V9.2c0-0.8-0.4-1.2-1-1.2  c-0.6,0-1,0.4-1.1,1.1l-0.1,0.8C21.4,9.8,22.2,9.8,22.9,10L22.9,10z M9.1,10c0.4-0.1,0.9-0.2,1.3-0.2c0.3,0,0.6,0,1,0.1l-0.1-0.8  C11.1,8.3,10.7,8,10.1,8c-0.6,0-1,0.4-1,1.2V10z"
              fill="#2D2D2D"
              stroke="#FFFFFF"
              strokeWidth="1.3333"
              strokeMiterlimit="5.3333"
