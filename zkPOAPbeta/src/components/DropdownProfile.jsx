...
import UserAvatar from '../images/mina-mina-logo.png';


import { useDispatch, useSelector } from 'react-redux';
import { userLogin } from '../features/auth/authActions'; // Import the async thunk
...
console.log(userInfo,"userInfo")
  ...
  const handleLogout = () => {
      ...
      dispatch(logout());
          window.location.href = '/'; // Navigate to /register after logout
    };
    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium text-gray-600 dark:text-gray-100 group-hover:text-gray-800 dark:group-hover:text-white">{userInfo.username}.</span>
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
            <div className="font-medium text-gray-800 dark:text-gray-100">{userInfo.email}.</div>
