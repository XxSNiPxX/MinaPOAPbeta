...
const NEXT_PUBLIC_ZKCW_AUTH="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkI2MnFrMmVpelJjUFp0cVVLenNiTmNTS0RNTVlVWW5pd2lKN25qZGdvQkRScml2UnB6M0VtVkEiLCJpYXQiOjE3MzQyNjA2NzcsImV4cCI6MTc2NTc5NjY3N30.lF5SQSEfL6tTImOGETU1YnrHejdtgzm5jU8u-Nk_khk"
const NEXT_PUBLIC_ZKCW_ENDPOINT='https://api.zkcloudworker.com/v1/'
...
async function zkCloudWorkerRequest(params: any) {
  ...
  const apiData = {
    auth: NEXT_PUBLIC_ZKCW_AUTH,
    command: command,
    jwtToken: NEXT_PUBLIC_ZKCW_AUTH,
    data: {
      task,
  ...
  const endpoint = NEXT_PUBLIC_ZKCW_ENDPOINT + chain;
